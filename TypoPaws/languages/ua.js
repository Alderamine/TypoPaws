...
languageSet.set(
  "lang__about_par",
  `
  Сліпий метод набору або ж десятипальцевий метод друку — набір тексту «наосліп», тобто не дивлячись на клавіші друкарської машинки або ж клавіші комп'ютерної клавіатури. При цьому використовуються усі десять пальців рук (хоч можливе застосування меншої кількості пальців), iснує вже більше 120 років.
<br>Кількість слів/знаків за хвилину, зазвичай скорочено wpm (іноді великими літерами WPM), — це кількість слів, що людина друкує за хвилину і часто використовується для вимірювання швидкості набору тексту.

  Typopaws - це вебдодаток, який допоможе вам покращити або просто перевірити
                    навички набору тексту. Мета програми - полегшити навчання на початку
...
languageSet.set("lang__res", "Корисні ресурси");
languageSet.set(
  "lang__res_par",
